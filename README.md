...
Office roles take a 30% penalty. Missing hours assume 40/wk. Missing pay scores zero, so thin listings sink. Pay is parsed from the listing — never invented from seniority.
